...
// # define __NODE		ft::RB_Node	 // name of your strucure/class which contain your node
// # define __VALUE	ft::RB_Node::data	 // name of your value variable in your structure/class
// # define __SIZE		5		 // size between nodes (only for display)
// # define __ROOT		ft::RB_tree::root	 // name of your tree's root variable
// # define __IS_BLACK	ft::RB_Node::color // name of the bool variable for the color of nodes
// # define __NIL		ft::RB_tree::Tnil		 // name of your NULL pointer
// # define __RIGHT	ft::RB_Node::right	 // name of the right child of your nodes
// # define __LEFT		ft::RB_Node::left	 // name of the left child of your nodes
